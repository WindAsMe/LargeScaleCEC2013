...
def draw_var(x, y1, y4, name):
    ...
    plt.legend()
    plt.savefig(
        'C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200808\DimensionReductionForSparse\data\pic\\' + name + '_var')
    plt.show()
...
def write_grouping(path, groups):
    with open('C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200808\DimensionReductionForSparse\grouping\\' + path, 'w') as file:
        for g in groups:
            file.write(str(g) + ', ')
    file.close()
