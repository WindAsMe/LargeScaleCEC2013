...
def draw_obj(x1, x2, y1, y4, name):
    ...
    plt.legend()
    plt.savefig(
        'C:\\Users\ZhongRui\Desktop\LargeScaleCEC2013-master\in20200808\DimensionReductionForSparse\data\pic\\' + name + '_obj')
    plt.show()
...
def draw_var(x, y1, y4, name):
    ...
    plt.legend()
    plt.savefig(
        'C:\\Users\ZhongRui\Desktop\LargeScaleCEC2013-master\in20200808\DimensionReductionForSparse\data\pic\\' + name + '_var')
    plt.show()
...
def write_obj_trace(path, fileName, trace):
    full_path = "C:\\Users\ZhongRui\Desktop\LargeScaleCEC2013-master\in20200808\DimensionReductionForSparse\data\\trace\\obj\\" + path + "\\" + fileName
...
def write_var_trace(path, fileName, trace):
    full_path = "C:\\Users\ZhongRui\Desktop\LargeScaleCEC2013-master\in20200808\DimensionReductionForSparse\data\\trace\\var\\" + path + "\\" + fileName
    with open(full_path, 'a') as f:
        f.write('[')
        for i in range(len(trace)):
            f.write('[')
...
def write_grouping(path, groups):
    with open('C:\\Users\ZhongRui\Desktop\LargeScaleCEC2013-master\in20200808\DimensionReductionForSparse\grouping\\' + path, 'w') as file:
        for g in groups:
            file.write(str(g) + ', ')
    file.close()
