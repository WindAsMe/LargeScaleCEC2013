...
def write_CCDE_trace(path, fileName, trace):
    full_path = "D:\CS2019KYUTAI\PythonProject\SparseModeling\in20210106\DimensionReductionForSparse\data\\trace\obj\\" + path + "\\" + fileName
...
def draw_summary(x, x_LASSO, x_DECC_DG, x_DECC_D, x_DECC_CL, LASSO_ave, Normal_ave, One_ave,
                      DECC_DG_ave, DECC_D_ave, DECC_G_ave, DECC_CL1_ave, DECC_CL2_ave, name):
    ...
    plt.semilogy(x_DECC_CL, DECC_CL1_ave, label='DECC-CL1')
    plt.semilogy(x_DECC_CL, DECC_CL2_ave, label='DECC-CL2')

    # plt.plot(x_LASSO, LASSO_ave, label='DECC-L')
    # plt.plot(x, One_ave, label='CCDE')
    # plt.plot(x, Normal_ave, label='Normal')
    # plt.plot(x, DECC_G_ave, label='DECC-G')
    # plt.plot(x_DECC_D, DECC_D_ave, label='DECC-D')
    # plt.plot(x_DECC_DG, DECC_DG_ave, label='DECC-DG')
    # plt.plot(x_DECC_CL, DECC_CL1_ave, label='DECC-CL1')
    # plt.plot(x_DECC_CL, DECC_CL2_ave, label='DECC-CL2')
