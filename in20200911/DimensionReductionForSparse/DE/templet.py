...
class soea_SaDE_templet(ea.SoeaAlgorithm):
    ...
    def run(self, prophetPop, Max_iteration):
        ...
        while not self.terminated(population):
            ...
            # self.mutOper = ea.Mutde(F=help.self_adaptive_F(flag, Max_iteration, 5))
            self.mutOper = ea.Mutde(F=help.high_low_F(5, 0.2, flag, Max_iteration))
            self.recOper = ea.Xovexp(XOVR=help.high_low_F(0.8, 0.2, flag, Max_iteration), Half=True)
