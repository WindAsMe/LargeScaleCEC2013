from in20210119.DimensionReductionForSparse.main_interface import f
from in20210119.DimensionReductionForSparse.util import help
from in20210119.DimensionReductionForSparse.main_interface.grouping_main import LASSOCC, DECC_DG, DECC_D, DECC_G, CCDE, Normal
...
if __name__ == '__main__':
    ...
    for func_num in range(4, 12):
        ...
        for i in range(test_time):
            ...
            f.DECC_CL_exe(Dim, func_num, NIND, m1, scale_range, groups_One, groups_One, 1000, 'DECC_CL')
