from in20200706.SparseModelForGroupingOptimization.Sparse import SparseModel
from in20200706.SparseModelForGroupingOptimization.util import benchmark, help, aim
from in20200706.SparseModelForGroupingOptimization.DE import DE
import numpy as np
...
if __name__ == '__main__':
    ...
    train_data = help.read_train_data(Func_Dim, Model_Dim, func_num)
    train_label = help.read_train_label(Func_Dim, Model_Dim, func_num)

    reg_Lasso, feature_names = SparseModel.Regression(degree, train_data, train_label, Model_Dim)
