...
def draw_obj(x, y1, label, name):
    ...
    plt.legend()
    plt.savefig(
        'C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200913\DimensionReductionForSparse\data\pic\\' + name + '_obj')
    plt.show()
...
def write_obj_trace(path, fileName, trace):
    full_path = "C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200913\DimensionReductionForSparse\data\\trace\\obj\\" + path + "\\" + fileName
...
def write_var_trace(path, fileName, trace):
    full_path = "C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200913\DimensionReductionForSparse\data\\trace\\var\\" + path + "\\" + fileName
    with open(full_path, 'a') as f:
        f.write('[')
        for i in range(len(trace)):
            f.write('[')
...
def write_final(d1, d2, d3, d4):
    with open('C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in202009138\DimensionReductionForSparse\data\\trace\\final\\LASSO', 'a') as file:
        file.write(str(d1) + ', ')
    file.close()
    with open('C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200913\DimensionReductionForSparse\\trace\\final\\Normal', 'a') as file:
        file.write(str(d2) + ', ')
    file.close()
    with open('C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200913\DimensionReductionForSparse\data\\trace\\final\\One', 'a') as file:
        file.write(str(d3) + ', ')
    file.close()
    with open('C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200913\DimensionReductionForSparse\data\\trace\\final\\Random', 'a') as file:
        file.write(str(d4) + ', ')
    file.close()
...
def write_elite(data, func_name):
    with open('C:\\Users\86150\Desktop\LargeScaleCEC2013-master\in20200913\DimensionReductionForSparse\data\\elite\\' + func_name, 'a') as file:
        file.write('[')
